...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '39b3edc3-ab76-467c-bd95-0d595ae8d5bb' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('025eede2-7146-4751-af26-d4755f8838e5');
      cy.get(`[data-cy="name"]`).should('have.value', '025eede2-7146-4751-af26-d4755f8838e5');
