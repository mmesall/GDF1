...
describe('Diplome Management Delete Component', () => {
  let comp: DiplomeDeleteDialogComponent;
  let fixture: ComponentFixture<DiplomeDeleteDialogComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .compileComponents();
    fixture = TestBed.createComponent(DiplomeDeleteDialogComponent);
