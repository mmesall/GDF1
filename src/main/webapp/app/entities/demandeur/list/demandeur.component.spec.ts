...
import { sampleWithRequiredData } from '../demandeur.test-samples';
...
describe('Demandeur Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, DemandeurComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to demandeurService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDemandeurIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDemandeurIdentifier).toHaveBeenCalledWith(entity);
