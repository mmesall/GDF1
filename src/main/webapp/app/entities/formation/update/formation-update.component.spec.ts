...
describe('Formation Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, FormationUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call Etablissement query and add missing value', () => {
      ...
      const etablissements: IEtablissement[] = [{ id: 25404 }];
      formation.etablissements = etablissements;

      const etablissementCollection: IEtablissement[] = [{ id: 17400 }];
    ...
    it('Should update editForm', () => {
      const formation: IFormation = { id: 456 };
      const etablissement: IEtablissement = { id: 29922 };
