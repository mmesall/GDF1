...
import { sampleWithRequiredData } from '../concours.test-samples';
...
describe('Concours Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ConcoursComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to concoursService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getConcoursIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getConcoursIdentifier).toHaveBeenCalledWith(entity);
