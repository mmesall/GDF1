...
import { sampleWithRequiredData } from '../bailleur.test-samples';
...
describe('Bailleur Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, BailleurComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to bailleurService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBailleurIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBailleurIdentifier).toHaveBeenCalledWith(entity);
