...
import { sampleWithRequiredData } from '../professionnel.test-samples';
...
describe('Professionnel Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ProfessionnelComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to professionnelService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProfessionnelIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProfessionnelIdentifier).toHaveBeenCalledWith(entity);
