...
import { sampleWithRequiredData } from '../prise-en-charge.test-samples';
...
describe('PriseEnCharge Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, PriseEnChargeComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to priseEnChargeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPriseEnChargeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPriseEnChargeIdentifier).toHaveBeenCalledWith(entity);
